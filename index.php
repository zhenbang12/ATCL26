...
$router->get('/participants/blocked', 'ParticipantController@blocked');
$router->post('/participants/anomalies/save-settings', 'ParticipantController@saveAnomaliesSettings');
$router->post('/participants/remove-anomaly', 'ParticipantController@removeAnomaly');
$router->post('/participants/anomalies/add-constraint', 'ParticipantController@addConstraint');
$router->post('/participants/anomalies/delete-constraint', 'ParticipantController@deleteConstraint');
$router->post('/participants/anomalies/toggle-constraint', 'ParticipantController@toggleConstraint');
